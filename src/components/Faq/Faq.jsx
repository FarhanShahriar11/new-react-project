...
const Faq = () => {
    return (
        <div className='faq-container'>
             ...
             <div>
           <div>
           <h3 className='font-bold p-2'>1.Different between props and state?</h3>
           ...
           <div>
            <h3 className='font-bold p-2'>3.what is done by useeffect beside the data fetching?</h3>
           ...
           <div>
            <h3 className='font-bold p-2'>4.how does react work?</h3>
